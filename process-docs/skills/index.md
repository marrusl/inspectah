...
| [web-disposition-contract](web-disposition-contract.md) | Web API sends `FindingKind` as a tagged union, not a bool; TS branches on `kind`; config advisories restore from the original snapshot, not the projection |
