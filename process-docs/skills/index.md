...
| [el8-platform-compatibility](el8-platform-compatibility.md) | EL8 platform considerations: no bootc image exists, map up to EL9 with :latest tag, version clamping semantics |
